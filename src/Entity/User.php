...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function getNbEssaiInfructueux(): ?int
    {
        return $this->nbEssaiInfructueux;
    }

    public function setNbEssaiInfructueux(int $nbEssaiInfructueux): self
    {
        $this->nbEssaiInfructueux = $nbEssaiInfructueux;
